### Using X_test for clustering and Neighbourhood Cleaning
# A, C
...
def cus_sampler_new_7(X_train, y_train, X_test, number_of_clusters=23, percentage_to_choose_from_each_cluster=0.50):
    """
...
#             print("end")
            ...
            for i in minority_point_under_this_cluster:
                ...
                selected_majority_instances = sorted_majority_distance[number_of_selected_points:]
