### Select 50% point near center and 50% far from center in total point which is 50% of majority class & Neighbourhood Cleaning
# B, C
...
def cus_sampler_new_8(X_train, y_train, number_of_clusters=23, percentage_to_choose_from_each_cluster=0.50):
    """
